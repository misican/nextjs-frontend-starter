...
## AI Customization Canonical Paths
- Canonical source for AI customization files is `.ai/`.
- `.github/` and `.cursor/` are IDE discovery links generated by `pnpm ai:setup`; do not edit them directly.
